...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> addBooking(long userId, BookingFromFrontDto bookingFromFrontDto) {
        return post("", userId, bookingFromFrontDto);
    }
    ...
    public ResponseEntity<Object> findBookingForApprove(long userId, long bookingId, boolean approved) {
        Map<String, Object> parameters = Map.of(
                "approved", approved
        );
