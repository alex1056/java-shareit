...
CREATE TABLE IF NOT EXISTS PUBLIC.REQUESTS (
                                ...
                                requester_id BIGINT,
                                created TIMESTAMP,
                                CONSTRAINT requests_pk_request PRIMARY KEY (id),
                                CONSTRAINT requests_fk_requester_id FOREIGN KEY (requester_id) REFERENCES PUBLIC.USERS(id) ON DELETE SET NULL
                               );